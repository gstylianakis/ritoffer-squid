...
export const events = {
    ...
    Minted: new LogEvent<([minter: string, nftID: ethers.BigNumber, uri: string] & {minter: string, nftID: ethers.BigNumber, uri: string})>(
        abi, '0xe7cd4ce7f2a465edc730269a1305e8a48bad821e8fb7e152ec413829c01a53c4'
    ),
